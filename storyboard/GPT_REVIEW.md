...
Reviewed at merge `dd63135`. Sources: `video-script/GPT.md` (315 lines),
`storyboard/GPT.md` (1,325 lines), `src/videos/glm-320b/gpt-watch/`.
...
The causal spine at the end of `storyboard/GPT.md` is sound, and three things
...
`storyboard/GPT.md` closes with a list titled *"What this GPT version
...
5. **Roughly 45% of every frame is empty.** Content sits in a band from
   y≈300 to y≈820 of 1080. `storyboard/GPT.md` specifies the safe teaching
