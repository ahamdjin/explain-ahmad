...
export const BEATS: Beat[] = [
  { n: 1, id: 'model-sheet', world: 'model', chapter: 'MODEL', learn: 'This is an illustrated model sheet, not a website dashboard.', cue: 'Draw the paper and model sheet.' },
  { n: 2, id: 'model-name', world: 'model', chapter: 'MODEL', learn: 'The example model is GLM-5.3-Flash from Z.ai.', cue: 'Write the model name.' },
  { n: 3, id: 'model-type', world: 'model', chapter: 'MODEL', learn: 'GLM-5.3-Flash is a Mixture-of-Experts model.', cue: 'Introduce MoE only as the model family.' },
  { n: 4, id: 'total-params', world: 'model', chapter: 'MODEL', learn: 'The whole model stores 320B learned parameters.', cue: 'Make 320B the first hero number.' },
  { n: 5, id: 'active-params', world: 'model', chapter: 'MODEL', learn: 'About 18B parameters participate in one token path.', cue: 'Reveal ~18B beside 320B.' },
  { n: 6, id: 'highlight-numbers', world: 'model', chapter: 'MODEL', learn: 'Total and active are the two words that matter.', cue: 'Physically highlight TOTAL and ACTIVE.' },
  { n: 7, id: 'define-parameter', world: 'model', chapter: 'MODEL', learn: 'A parameter is one learned number inside the model.', cue: 'Add the definition beside 320B.' },
  { n: 8, id: 'define-active', world: 'model', chapter: 'MODEL', learn: 'Active means used for this token right now.', cue: 'Add the definition beside 18B.' },
  { n: 9, id: 'model-architecture', world: 'model', chapter: 'MODEL', learn: '45 layers, 42 sparse-MoE layers, 288 routed experts, top-8 + one shared expert are the architecture facts we need later.', cue: 'Write supporting architecture quietly in the margin.' },
  { n: 10, id: 'hook-question', world: 'model', chapter: 'MODEL', learn: 'The video question is how 320B and 18B can both be true.', cue: 'Draw a pencil bracket 320B → ? → 18B.' },
  { n: 11, id: 'follow-one-prompt', world: 'model', chapter: 'MODEL', learn: 'We will answer the question by following one tiny piece of text.', cue: 'Introduce the detour deliberately.' },
  { n: 12, id: 'journey-map', world: 'model', chapter: 'MODEL', learn: 'The whole journey is Text → Tokens → Token ID → Embedding → Attention → MoE → Layers → Output.', cue: 'Draw the full route large enough to read.' },
  { n: 13, id: 'journey-icons', world: 'model', chapter: 'MODEL', learn: 'Each chapter has a visual metaphor that will reappear later.', cue: 'Add small chapter symbols.' },
  { n: 14, id: 'enter-text', world: 'model', chapter: 'TEXT', learn: 'The journey map becomes persistent navigation.', cue: 'Shrink the same chapter objects into the top rail and enter Text.' },
