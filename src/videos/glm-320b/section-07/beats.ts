 ...
 *
 * Board: `video-script/07-one-layer-of-forty-five.md`. `npm run check:board`.
 *
...
export const BEATS: Beat<Patch>[] = [
  ...
  },
  {
    ...
    relation: 'so',
    secs: 8,
    vo: 'Which means the row arriving at floor two is not the row that arrived at floor one.',
  ...
  },
  {
    ...
    relation: 'so',
    secs: 5,
    vo: 'Different row. Different scores.',
    commands: [],
  ...
  },
  {
    ...
    relation: 'and-yet',
    secs: 12,
    vo: 'Three hundred and thirty-six choices, for one token — and every single one of them needed the floor below to finish before it could be made.',
