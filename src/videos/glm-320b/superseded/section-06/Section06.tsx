...
/** Section 03. Script: video-script/video-1/06-forty-two-floors.md */
export default function Section06({
  ...
  return (
    <SectionRunner
      ...
      onFinish={onFinish}
      autoplay={autoplay}
      // Drop a track at public/vo/06.mp3 and it becomes the master clock.
      audioSrc={VO}
      label="How many times the choice is made"
    >
