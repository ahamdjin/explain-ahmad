...
export function PaperDefs() {
  return (
    <svg className="g1-defs" aria-hidden="true" focusable="false">
      <defs>
        <filter id="g1-ink" x="-12%" y="-12%" width="124%" height="124%">
        ...
        <filter id="g1-ink-soft" x="-12%" y="-12%" width="124%" height="124%">
        ...
        <filter id="g1-grain" x="0" y="0" width="100%" height="100%">
