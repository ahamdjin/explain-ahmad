...
export const vocab = {
   ...
   *
   * Without the label the highlighted row draws whatever the component's
   * sample entry list holds at that index -- it was highlighting the followed
   * token's row and captioning it with an unrelated word.
   */
