...
This version does not replace `01-opening-narration.md`. It builds a full spoken story from the current `storyboard/video-1/SECTION_MAP.md`, the GLM research, and the teaching rules in `skills/`.
